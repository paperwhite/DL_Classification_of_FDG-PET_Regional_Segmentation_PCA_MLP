...
path='/home/shibanis/Downloads/ss/all_files_LMCI_EMCI'
...
for filename in os.listdir(path):
    if (os.path.isfile(os.path.join('build_lm_em','res_'+filename))):
    ...
    #print(np.isnan(img_arr).sum())
        ...
        new_image.to_filename(os.path.join('build_lm_em','res_'+filename))
